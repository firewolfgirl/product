...
public class StrategyServiceImpl implements StrategyService {
	...
	public List<Strategy> findNew() {
		List<Strategy> list = strategyDAO.findNew();
		return list;
	}

	@Override
	public List<Strategy> findAll() {
		List<Strategy> list = strategyDAO.findAll();
		return list;
	}
	
	@Override
	public StrategyDetails findById(int id) {
		StrategyDetails strategyDetails=new  StrategyDetails();
		strategyDetails=strategyDetailsDAO.findStrategyDetails(id);
