...
@Service
public class StrategyDetailsServiceImpl implements StrategyDetailsService{

	@Autowired
	private StrategyDetailsDAO strategyDetailsDAO ;

	@Override
	public List<StrategyDetails> findNew() {
		List<StrategyDetails> list = strategyDetailsDAO.findNew();
		return list;
	}

	@Override
	public List<StrategyDetails> findAll() {
		List<StrategyDetails> list = strategyDetailsDAO.findAll();
		return list;
	}
